...
oProject = oDesktop.SetActiveProject("U_Slot_Patch_Antenna")
oDesign = oProject.SetActiveDesign("USlotPatch")
...
oModule.ExportToFile("SParams", "C:/Users/mavarma/Dropbox (University of Michigan)/YOUTUBE Tutorials/AntennasAndArrays 01 - U Slot Patch Antenna/SParams.csv", False)
